...
import { checkBackendHealth, API_BASE_URL } from "./services/apiService";
import "./App.css";
...
function App() {
  ...
  // Backend Health Connection State ("connecting" | "connected" | "disconnected")
      ...
      <nav className="navbar">
        ...
        <div className="nav-actions">
          ...
          <button
            ...
            title={`Backend Health Status (${API_BASE_URL}/api/health) - Click to recheck`}
          >
